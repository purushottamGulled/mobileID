  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Authentication</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <h5><span>4 - Click the <b>Authenticate button</b></span></h5>
   <!--    <a
  href="http://127.0.0.1:4444/oauth2/auth/?client_id='sample_user'&scope=offline_access&redirect_uri=http://127.0.0.1:5555/callback"
>
  Connect with ...
</a> -->
      <button class="btn btn-primary button" id="activate_device" onclick='doAuthenticate()'>Authenticate</button>
